...
# Uncomment and change the line below if you're having to set this up in your own virtualenv environment. If you don't know what that is, then it doesn't apply to you.
# source /**YOUR VIRTUALENV DIRECTORY**/virtualenv/bin/activate

scriptDir="." # You'll need to point this at the get_queue.py script that sits on your machine.
